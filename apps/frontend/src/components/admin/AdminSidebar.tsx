        ...
        <div className="flex flex-col h-full">
          ...
          >
            ...
            <div className={`flex items-center justify-between w-full ${isCollapsed ? "md:hidden" : "flex"}`}>
              <Link href="/console" onClick={onClose} className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-extrabold uppercase tracking-wider bg-red-50 text-red-700 px-2 py-0.5 rounded-md border border-red-200">
                  Admin
                </span>
              </Link>
